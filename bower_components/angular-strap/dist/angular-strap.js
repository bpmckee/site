...
(function (window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.datepicker', [
    ...
    this.$get = [
      ...
      'datepickerViews',
      '$popover',
      function ($window, $document, $rootScope, $sce, $locale, dateFilter, datepickerViews, $popover) {
        var bodyEl = angular.element($window.document.body);
        ...
        function DatepickerFactory(element, controller, config) {
          var $datepicker = $popover(element, angular.extend({}, defaults, config));
    ...
    function ($window, $location, $sce, $popover) {
      ...
      return {
        ...
        link: function postLink(scope, element, attr) {
          ...
          attr['content'] && attr.$observe('content', function (newVal, oldVal) {
            scope['content'] = newVal;
            angular.isDefined(oldVal) && requestAnimationFrame(function () {
